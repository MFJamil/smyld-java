...
public class DockablePanelTransferHandler extends TransferHandler implements
		Transferable {
	/**
	 * 
	 */
	...
	DataFlavor panelDF;// =new DataFlavor(com.smyld.gui.panels.DockablePanel,"SMYLD
						// Dockable Panel");

	public DockablePanelTransferHandler(DockablePanel component) {
		draggedPanel = component;
		panelDF = new DataFlavor(component.getClass(), "SMYLD Dockable Panel");
	}
