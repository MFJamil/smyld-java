...
import org.smyld.text.BracketsParser;
import org.smyld.text.MultiTextTokenizer;
...
public class Tester {
	...
	public void testCodeCreation() {
		 ...
		 * System.out.println(test.print());
		 */
		JavaClassBody test = new JavaClassBody("Tester", "org.smyld",
				"SMYLDObject", true, false);
		test.addImport("org.smyld.util");
