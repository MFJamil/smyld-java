...
public class TextUtil extends SMYLDObject {
	/**
	 * 
	 */
	...
	public static synchronized String createWord(String fillingText,
			int iterationNo) {
	...
	public static synchronized String fillLeftSideWithSpaces(String value,
			int width) {
		return fillText(value, width, ' ', true);
	}

	public static synchronized String fillRightSideWithSpaces(String value,
			int width) {
		return fillText(value, width, ' ', false);
	}

	public static synchronized String fillLeftSide(long value, int width,
			char fillingChar) {
		return fillText(Long.toString(value), width, fillingChar, true);
	}

	public static synchronized String fillLeftSide(String value, int width,
			char fillingChar) {
		return fillText(value, width, fillingChar, true);
	}

	public static synchronized String fillRightSide(String value, int width,
			char fillingChar) {
	...
	public static synchronized boolean withinRange(String textValue,
	...
	public static synchronized String fillText(String value, int width,
	...
	public static synchronized String composeWithSeparator(String[] data,
			String separator) {
		StringBuffer buffer = new StringBuffer();
		String result = null;
		if (data != null)
	...
	public static synchronized String replace(StringBuffer sourceDocument,
	...
	public static synchronized String replace(File targetFile,
			String startBlock, String endBlock, String newSectionData) {
	...
	public static synchronized String replace(Reader sourceDataReader,
			String startBlock, String endBlock, String newSectionData) {
	...
	public static synchronized String fetchSectionData(File searchFile,
	...
	public static synchronized String getSectionText(String targetText,
	...
	public static synchronized Vector<String> getAllSectionText(String targetText,
			String firstText, String lastText) {
