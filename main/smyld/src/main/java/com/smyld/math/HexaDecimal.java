...
public class HexaDecimal {
	...
	public synchronized static String convertToBinary(String HexaTextValue) {
	...
	public static String toHexString(byte[] byteValues) {
	...
	public static String getHexaFromAscii(String acsiiText) {
	...
	public static String parse(byte[] byteValue) {
	...
	private static StringBuffer doInitBuffer(StringBuffer buffer) {
		if (buffer == null)
	...
	public static synchronized String parseBinaryValueText(String binaryValue) {
	...
	public static String getHexFromBinary(String binaryValue) {
