package com.smyld.app.portalengine;


import com.smyld.gui.portal.engine.PortalManager;
import com.smyld.gui.portal.engine.projectbuilder.MavenProjectBuilder;
import com.smyld.gui.portal.engine.projectbuilder.ProjectBuilder;
        ...
        try {
            ...
            for (Object curRes:project.getResources()){
                if (curRes instanceof Resource){
                   ...
                   mvnRes.setTargetPath("com/smyld/resources");
