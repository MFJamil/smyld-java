...
public class PEAppV1XmlReader extends PEAppXMLReader implements PEApplication {
     ...
     * @since
     */
    public PEAppV1XmlReader(String appXMLDoc, ProjectBuilder prjBuilder) throws Exception {
        super(appXMLDoc);
        projectBuilder = prjBuilder!=null? Optional.of(prjBuilder): Optional.empty();
        doInit();
    }
    public PEAppV1XmlReader(InputStream appXMLStream, ProjectBuilder prjBuilder) throws Exception {
        super(appXMLStream);
        projectBuilder = prjBuilder!=null? Optional.of(prjBuilder): Optional.empty();
        doInit();
    }
