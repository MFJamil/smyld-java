...
public class Tester extends SMYLDObject implements PESwingApplicationReader {//WindowPanelListener,
	...
	private void testClassRef() {
		try {
			Class<?> target = ClassLoader.getSystemClassLoader().loadClass(
					"com.smyld.lang.script.java.JavaClassBody");
	 ...
	 * att = new Attributes();
	 * att.putValue(Attributes.Name.MAIN_CLASS.toString(),"com.smyld.com.Tester");
	 ...
	 * com.smyld.app.bw.mgui.MainClass")+System.getProperty("line.separator")).getBytes());
	...
	private void testJarArchive() {
		try {
			...
			FileInputStream fin = new FileInputStream(
					"d:/temp/projects/BW/classes/com/smyld/app/bw/mgui/MainClass.class");

			JarOutputStream jout = new JarOutputStream(fout);

			JarEntry newFile = new JarEntry(
					"com/smyld/app/bw/mgui/MainClass.class");
