...
import static com.smyld.app.AppConstants.MENU_TYPE_CLASSIC;
import static com.smyld.app.AppConstants.MENU_TYPE_TREE;
import static com.smyld.app.AppConstants.SETT_XML_ATT_DEFAULT;
import static com.smyld.app.AppConstants.SETT_XML_NODE_LAF;
import static com.smyld.app.AppConstants.SETT_XML_NODE_LAFS;
import static com.smyld.app.AppConstants.SETT_XML_NODE_LANG;
import static com.smyld.app.AppConstants.SETT_XML_NODE_LANGS;
import static com.smyld.app.AppConstants.SETT_XML_NODE_RES;
import static com.smyld.app.AppConstants.SETT_XML_NODE_RESS;
import static com.smyld.app.pe.model.Constants.*;
...
import com.smyld.app.pe.annotations.PEApplicationSource;
import com.smyld.app.pe.annotations.PELayoutHandler;
import com.smyld.app.pe.annotations.PEReadApplication;
import com.smyld.app.pe.exceptions.PortalFatal;
import com.smyld.app.pe.input.xml.PEAppXMLReader;
...
import com.smyld.app.pe.projectbuilder.MavenProjectBuilder;
import com.smyld.app.pe.projectbuilder.ProjectBuildSource;
...
import com.smyld.deploy.web.WebDeploymentDescriptor;
import com.smyld.deploy.web.jnlp.JNLPDeploymentDescriptor;
import com.smyld.deploy.web.jnlp.JNLPHTMLDocument;
import com.smyld.deploy.web.jnlp.ShortcutDescriptor;
...
public class PortalAppXMLSetReaderPESwing extends PEAppXMLReader implements
	...
	public String getGroup() {
		return XMLUtil.getChildValue(buildApplication,TAG_NAME_GROUP,"com.smyld.apps");
	}
